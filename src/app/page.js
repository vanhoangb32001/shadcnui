...
export default function ShadcnUIShowcase() {
  ...
  const componentSections = [
    ...
    },
    {
      id: "data-display",
      title: "Data Display",
      components: ["Card", "Badge", "Avatar", "Table", "Accordion", "Progress"],
    },
    {
      id: "overlay",
      title: "Overlay",
      components: ["Dialog", "Sheet", "Hover Card", "Context Menu"],
    },
    {
      id: "utility",
      title: "Utility",
      components: ["Command", "Scroll Area", "Separator"],
    },
    { id: "custom", title: "Custom Components", components: ["Date Picker"] },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-900 via-pink-800 to-pink-900 text-white overflow-hidden">
      {/* Header */}
      <header
        className={`flex items-center justify-between p-6 transition-all duration-1000 transform ${
      ...
      <main className="container mx-auto px-6 py-12 max-w-6xl">
        {/* Hero Section */}
        <div
          className={`flex flex-col items-center text-center mb-20 transition-all duration-1000 transform ${
            isVisible
              ...
              <section key={section.id} id={section.id}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button
                            variant="outline"
                            className="border-pink-500 text-pink-400 hover:bg-pink-900"
                          >
                            Outline
                          </Button>
                          <Button
                            variant="ghost"
                            className="text-pink-400 hover:bg-pink-900"
                          >
                            Ghost
                          </Button>
                          <Button
                  ...
                  {section.components.includes("Input") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Collect user input with styled text fields.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                  ...
                  {section.components.includes("Textarea") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        <CardTitle className="text-pink-300">
                          Textarea
                        </CardTitle>
                        <CardDescription className="text-pink-200">
                  ...
                  {section.components.includes("Checkbox") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Toggleable input for multiple selections.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-2">
                        <div className="flex items-center space-x-2">
                          <Checkbox id="check1" />
                          <Label htmlFor="check1" className="text-pink-200">
                            Option 1
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox id="check2" disabled />
                          <Label htmlFor="check2" className="text-pink-200">
                            Disabled
                          </Label>
                        </div>
                      </CardContent>
                      ...
                      <CardContent>
                        <RadioGroup defaultValue="option1">
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="r1" className="text-pink-200">
                              Option 1
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="option2" id="r2" />
                            <Label htmlFor="r2" className="text-pink-200">
                              Option 2
                            </Label>
                          </div>
                        </RadioGroup>
                  ...
                  {section.components.includes("Switch") && (
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent className="space-y-2">
                        <div className="flex items-center space-x-2">
                          <Switch id="switch1" />
                          <Label htmlFor="switch1" className="text-pink-200">
                            Toggle
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Switch id="switch2" disabled />
                          <Label htmlFor="switch2" className="text-pink-200">
                            Disabled
                          </Label>
                        </div>
                      </CardContent>
                  ...
                  {section.components.includes("Toggle") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Button-like toggle with variants.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-2">
                        <Toggle className="bg-pink-600 hover:bg-pink-700">
                          Toggle
                        </Toggle>
                        <Toggle
                          variant="outline"
                    ...
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent>
                        <Tabs defaultValue="tab1" className="w-full">
                          ...
                          <TabsContent value="tab1" className="text-pink-200">
                            Content for Tab 1
                          </TabsContent>
                          <TabsContent value="tab2" className="text-pink-200">
                            Content for Tab 2
                          </TabsContent>
                        </Tabs>
                      </CardContent>
                    ...
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent>
                        <NavigationMenu>
                          <NavigationMenuList>
                            <NavigationMenuItem>
                              <NavigationMenuTrigger className="bg-pink-900 text-pink-200 hover:bg-pink-700">
                                Menu
                              </NavigationMenuTrigger>
                              <NavigationMenuContent className="bg-pink-800">
                                <NavigationMenuLink className="block p-2 text-pink-200 hover:bg-pink-700">
                                  Item 1
                                </NavigationMenuLink>
                                <NavigationMenuLink className="block p-2 text-pink-200 hover:bg-pink-700">
                                  Item 2
                  ...
                  {section.components.includes("Menubar") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Accessible menu bar for applications.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <Menubar className="bg-pink-900 border-pink-700">
                          <MenubarMenu>
                            <MenubarTrigger className="text-pink-200 hover:bg-pink-700">
                              File
                            </MenubarTrigger>
                            <MenubarContent className="bg-pink-800 border-pink-700">
                              <MenubarItem className="text-pink-200 hover:bg-pink-700">
                                New
                              </MenubarItem>
                              <MenubarItem className="text-pink-200 hover:bg-pink-700">
                                Open
                      ...
                      <CardContent>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent className="bg-pink-800 border-pink-700">
                            <DropdownMenuLabel className="text-pink-200">
                              My Account
                            </DropdownMenuLabel>
                            <DropdownMenuSeparator className="bg-pink-700" />
                            <DropdownMenuItem className="text-pink-200 hover:bg-pink-700">
                              Profile
                            </DropdownMenuItem>
                            <DropdownMenuItem className="text-pink-200 hover:bg-pink-700">
                              Settings
                    ...
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent>
                        <Alert className="border-pink-700 bg-pink-900">
                          <AlertTitle className="text-pink-300">
                            Heads up!
                          </AlertTitle>
                      ...
                      <CardContent>
                        <AlertDialog>
                          ...
                          <AlertDialogContent className="bg-pink-800 border-pink-700">
                            <AlertDialogHeader>
                              <AlertDialogTitle className="text-pink-300">
                                Are you sure?
                              </AlertDialogTitle>
                            ...
                            <AlertDialogFooter>
                              <AlertDialogCancel className="bg-pink-900 hover:bg-pink-700 text-pink-200">
                                Cancel
                              </AlertDialogCancel>
                  ...
                  {section.components.includes("Popover") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Display content in a floating container.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <Popover>
                  ...
                  {section.components.includes("Avatar") && (
                    <Card className="bg-pink-800 border-pink-700">
                      <CardHeader>
                        ...
                        <CardDescription className="text-pink-200">
                          Display user images or initials.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-2">
                        <div className="flex gap-4">
                          <Avatar>
                            <AvatarImage
                              ...
                              alt="@shadcn"
                            />
                            <AvatarFallback className="bg-pink-900 text-pink-200">
                              CN
                            </AvatarFallback>
                          </Avatar>
                          <Avatar>
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow className="border-pink-700 hover:bg-pink-900">
                              <TableHead className="text-pink-300">
                                Name
                              </TableHead>
                              <TableHead className="text-pink-300">
                                Role
                    ...
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                          ...
                          >
                            <AccordionTrigger className="text-pink-200 hover:text-pink-300">
                              Section 1
                            </AccordionTrigger>
                            <AccordionContent className="text-pink-200">
                  ...
                  {section.components.includes("Context Menu") && (
                    <Card className="bg-pink-800 border-pink-700">
                      ...
                      <CardContent>
                        <ContextMenu>
                          <ContextMenuTrigger>
                            <div className="p-4 bg-pink-900 rounded-md text-pink-200">
                              Right-click here
                            </div>
                          </ContextMenuTrigger>
                          <ContextMenuContent className="bg-pink-800 border-pink-700">
                            <ContextMenuItem className="text-pink-200 hover:bg-pink-700">
                              Action 1
                            </ContextMenuItem>
                            <ContextMenuItem className="text-pink-200 hover:bg-pink-700">
                              Action 2
                      ...
                      <CardContent>
                        <Command className="bg-pink-900 border-pink-700">
                          ...
                          <CommandList className="bg-pink-900">
                            <CommandEmpty className="text-pink-200">
                              No results found.
                            </CommandEmpty>
                            <CommandGroup
                              heading="Suggestions"
                            ...
                            >
                              <CommandItem className="text-pink-200 hover:bg-pink-700">
                                Command 1
                              </CommandItem>
                              <CommandItem className="text-pink-200 hover:bg-pink-700">
                                Command 2
                        ...
                        >
                          ...
                          >
                            View Docs
                                  ...
                                  {section.components.includes("Date Picker") && (
                    <DatePickerShowcase />
                  )}
              </section>
            ))}
      ...
      {/* Footer */}
      <footer
        className={`p-6 text-center text-pink-300 transition-all duration-1000 transform ${
          isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
        }`}
      >
        <div className="max-w-6xl mx-auto">
          <div className="py-4 border-t border-pink-700 flex flex-col md:flex-row justify-between items-center">
            <p>
              © 2025 Shadcn UI Showcase. Powered by{" "}
              <a
                href="https://ui.shadcn.com"
                className="text-pink-400 hover:text-pink-300"
              >
